from interfaces import AMessageTemplate
...
class FirstMsg(AMessageTemplate):
    NAME = 'dump'
    HEX = '10'
...
class ConfirmFirstMsg(AMessageTemplate):
    NAME = 'dump'
    HEX = '10'
...
class TableBytes(AMessageTemplate):
    NAME= 'TableBytes'
...
class RestDump(AMessageTemplate):
    NAME='RestDump'
...
class LinMemBytes(AMessageTemplate):
    NAME= 'LinMemBytes'
...
class SecondRestDump(AMessageTemplate):
    NAME='SecondRestDump'
...
class BRTableBytes(AMessageTemplate):
    NAME='BRTableBytes'
...
class EndOfDump(AMessageTemplate):
    NAME='EndOfDump'
...
class ConfirmRunMsg(AMessageTemplate):
    NAME = 'run_confirm'
...
class HaltMsg(AMessageTemplate):
    NAME = 'halt'
    HEX = '02'
...
class ConfirmHaltMsg(AMessageTemplate):
    NAME = 'halt_confirm'
...
class PauseMsg(AMessageTemplate):
    NAME = 'pause'
    HEX = '03'
...
class StepMsg(AMessageTemplate):
    NAME = 'step'
    HEX = '04'
...
class AddBreakPointMsg(AMessageTemplate):
    NAME = 'add_breakpoint'
    HEX = '06'
...
class ConfirmAddBP(AMessageTemplate):
    NAME = 'confirm_add_bp'
...
class RemoveBreakPointMsg(AMessageTemplate):
...
class ConfirmRemoveBP(AMessageTemplate):
...
class DumpMsg(AMessageTemplate):
    NAME = 'dump'
    HEX = '10'
...
class ConfirmDumpMsg(AMessageTemplate):
    NAME = 'confirm_dump'
...
class SomeHexElements(AMessageTemplate):
...
class SomeEndOfDump(AMessageTemplate):
    NAME='SomeEndOfDump'
...
class DumpLocals(AMessageTemplate):
    NAME = 'dump_local'
    HEX = '11'
...
class ConfirmDumpLocals(AMessageTemplate):
